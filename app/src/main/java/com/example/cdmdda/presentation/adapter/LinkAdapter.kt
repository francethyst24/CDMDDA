...
class LinkAdapter constructor(
    private val dataset: List<UiState>,
    private val padding: Int = -1,
    private val onTextClick: (UiState) -> Unit,
) {
    companion object {
        fun TextView.setLinkAdapter(adapter: LinkAdapter) = adapter.setClickableText(this)
    }
